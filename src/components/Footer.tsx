    ...
    return (
        <footer className="relative bg-[#050911] text-white pt-24 pb-8 px-10 lg:px-20">
            ...
            <div className="relative z-10 max-w-[1400px] mx-auto">
                ...
                {/* Footer Content */}
                <div className="grid grid-cols-1 md:grid-cols-12 gap-y-24 md:gap-y-0 md:gap-x-10 lg:gap-x-20">
                    {/* Brand & Address */}
                    ...
                    <div className="md:col-span-3 lg:col-span-2">
                        ...
                        <ul className="space-y-6 text-[15px] font-bold">
                            <li><a href={`mailto:${CONTENT.footer.contact.inquiries.email}`} className="hover:text-accent transition-colors whitespace-nowrap">{CONTENT.footer.contact.inquiries.email}</a></li>
                            <li><a href={`tel:${CONTENT.footer.contact.inquiries.phone}`} className="hover:text-accent transition-colors whitespace-nowrap">{CONTENT.footer.contact.inquiries.phone}</a></li>
                        </ul>
                    </div>

                    {/* Links */}
                    <div className="md:col-span-3 lg:col-span-2 ml-4">
                ...
                <div className="mt-4 flex flex-col md:flex-row justify-between items-end md:items-center text-[10px] uppercase tracking-widest text-zinc-600 font-bold">
                    <div className="space-y-2">
                        ...
                        <p>Website created by <span className="text-accent lowercase">neoworklabs</span></p>
                    </div>
